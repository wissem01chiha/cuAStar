...
#define BLAST_GLM (defined(BLAST_GLM) ? true : false)
#define BLAST_EIGEN (defined(BLAST_EIGEN) ? true : false)

#if !BLAST_TORCH && !BLAST_GLM && !BLAST_EIGEN
#define BLAST_EIGEN true
#endif

#if (BLAST_TORCH && BLAST_GLM)||(BLAST_TORCH && BLAST_EIGEN)||(BLAST_GLM && BLAST_EIGEN)
#pragma error("Only one of BLAST_TORCH, BLAST_GLM, or BLAST_EIGEN can be enabled at a time.")
#endif
...
{
private:
    Eigen::Vector<Precision,dim> defaultPose;
